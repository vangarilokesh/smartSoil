...
def fertilizer_recommendation():
    title = 'SmartSoil - Fertilizer Suggestion'
...
def crop_prediction():
    title = 'SmartSoil - Crop Recommendation'
...
def disease_prediction():
    title = 'SmartSoil - Disease Detection'
